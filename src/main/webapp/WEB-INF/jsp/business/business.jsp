...
<body>
		...
		<div data-role="content">
			<div data-role="collapsible-set">
				...
				<div data-role="collapsible">
					...
					<ul data-role="listview">
						<li>
							<a href="#business-goods">
								<img src="images/goods.jpg"/>
								<h1>GoodsName|SellCount|avgScroe</h1>
								<p>infomation</p>
							</a>
						</li>
					</ul>
	...
	<!-- business-goods -->
	<div data-role="page" id="business-goods">
		<div data-role="header">
		...
		<div data-role="content">
			<form>
				<label for="goodsId" class="ui-hidden-accessible">GoodsId:</label>
				<input type="text" name="goodsId" id="goodsId" class="ui-hidden-accessible" placeholder="Null stand for Create" />
				...
				<select name="goodsType" id="goodsType" data-role="none">
				...
				<textarea rows="" cols="" name="discription" id="discription"></textarea>
				...
				<label for="file">Goods Picture:</label>
	...
	<div data-role="page" id="orders" data-theme="a" data-title="Orders">
		...
		<div data-role="content" data-theme="c">
			<ul data-role="listview">
				<li>
					<a href="#goods?goodsId=1"> <img src="images/goods.jpg">
						<h1>goodsName</h1>
						<h2>Price | Creidt</h2>
						<h2>infomation</h2>
					</a>
	...
	<div data-role="page" id="business-customer">
		...
		<div data-role="content">
			<fieldset>
				...
				<h3>UserName:Tome</h>
				<h3>Phone:123123123</h>
				<h3>Birthday:123123123</h>
			</fieldset>
