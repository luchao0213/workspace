...
<body>
	<form:form modelAttribute="user" action="/doume/register/user_c" method="POST">
		<div>
			用户帐号：
	...
	<form:form modelAttribute="business" action="/doume/register/business"
		...
		<div>
			商家类型<form:label path="bType"/>
		</div>
		<div>
			租金:<form:label path="ppm" ></form:label>元/月
		</div>
		<div>
			余额:<form:label path="balance" ></form:label>元
		</div>
		<div>
			使用量／容量:<form:label path="used" ></form:label>/<form:label path="capacity" ></form:label>
		</div>
		<div>
